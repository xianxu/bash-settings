...
myStatusBar = "conky -c /home/xx/.xmonad/.conky_dzen | dzen2 -x '2080' -w '1040' -h '24' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
myBitmapsDir = "/home/xx/.xmonad/dzen2"
--}}}
-- Main {{{
main = do
...
keys' conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask,                    xK_q        ), spawn "killall conky dzen2 && /home/xx/.cabal/bin/xmonad --recompile && /home/xx/.cabal/bin/xmonad --restart")
    ]
    ++
